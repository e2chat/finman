        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
          <div>
            ...
            <div class="mt-2 grid grid-cols-2 sm:grid-cols-4 gap-1">
              <button type="button" @click="targetAmount = (targetAmount || 0) * 0.9" class="text-xs rounded bg-red-100 dark:bg-red-900 text-red-900 dark:text-red-100 px-2 py-1 hover:bg-red-200 dark:hover:bg-red-800">-10%</button>
              ...
              <button type="button" @click="targetAmount = (targetAmount || 0) * 1.1" class="text-xs rounded bg-purple-100 dark:bg-purple-900 text-purple-900 dark:text-purple-100 px-2 py-1 hover:bg-purple-200 dark:hover:bg-purple-800">+10%</button>
          ...
          <div>
            ...
            <div class="mt-2 grid grid-cols-2 gap-1">
              <button type="button" @click="currentAmount = (targetAmount || 0) * 0.1" class="text-xs rounded bg-amber-100 dark:bg-amber-900 text-amber-900 dark:text-amber-100 px-2 py-1 hover:bg-amber-200 dark:hover:bg-amber-800">10% of Target</button>
